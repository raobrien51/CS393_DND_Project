...
VALUES
    ...
    ('Charger', 4, 'General Feat, Increase your Strength or Dexterity score by 1, to a maximum of 20. When you take the Dash Action, your Speed increases by 10 feet for that action. If you move at least 10 feet in a straight line toward a target immediately before hitting it with a melee attack roll as part of the Attack action, choose one of the following effects: gain a 1d8 bonus to the attacks damage roll, or push the target up to 10 feet away if it is no more than one size larger than you. You can use this benefit only once on each of your turns.'),
    ...
    ('Dual Wielder', 4, 'General Feat,  Increase your Strength or Dexterity score by 1, to a maximum of 20. When you take the Attack action on your turn and attack with a weapon that has the Light property, you can make one extra attack as a Bonus Action later on the same turn with a different weapon, which must be a Melee weapon that lacks the Two-Handed property. You dont add your ability modifier to the extra attacks damage unless that modifier is negative. You can draw or stow two weapons that lack the Two-Handed property when you would normally be able to draw or stow only one.'),
    ...
    ('Durable', 4, 'General Feat,Increase your Constitution score by 1, to a maximum of 20. You have Advantage on Death Saving Throws. As a Bonus Action, you can expend one of your Hit Point Dice, roll the die, and regain a number of Hit Points equal to the roll.'),
    ('Elemental Adept', 4, 'General Feat,  Increase your Intelligence, Wisdom, or Charisma score by 1, to a maximum of 20. Choose one of the following damage types: Acid, Cold, Fire, Lightning, or Thunder. Spells you cast ignore Resistance to damage of the chosen type. In addition, when you roll damage for a spell you cast that deals damage of that type, you can treat any 1 on a damage die as a 2. You can take this feat more than once, but you must choose a different damage type each time for Energy Mastery.'),
    ('Grappler', 4, 'General Feat, Increase your Strength or Dexterity score by 1, to a maximum of 20. When you hit a creature with an Unarmed Strike as part of the Attack action on your turn, you can use both the Damage and the Grapple option. You can use this benefit only once per turn. You have Advantage on attack rolls against a creature Grappled by you. Your Speed isnt halved when you move a creature Grappled by you if the creature is your size or smaller.'),
    ...
    ('Great Weapon Master', 4, 'General Feat, Increase your Strength score by 1, to a maximum of 20. When you hit a creature with a weapon that has the Heavy property as part of the Attack Action on your turn, you can cause the weapon to deal extra damage to the target. The extra damage equals your Proficiency Bonus. Immediately after you score a Critical Hit with a Melee weapon or reduce a creature to 0 Hit Points with one, you can make one attack with the same weapon as a Bonus Action.'),
    ...
    ('Heavy Armor Master', 4, 'General Feat, Increase your Constitution or Strength score by 1, to a maximum of 20. When youre hit by an attack while youre wearing Heavy armor, any Bludgeoning, Piercing, and Slashing damage dealt to you by that attack is reduced by an amount equal to your Proficiency Bonus.'),
    ('Inspiring Leader', 4, 'General Feat, Increase your Wisdom or Charisma score by 1, to a maximum of 20. When you finish a Short Rest or a Long Rest, you can give an inspiring performance: a speech, song, or dance. When you do so, choose up to six allies (which can include yourself) within 30 feet of yourself who witness the performance. The chosen creatures each gain Temporary Hit Points equal to your character level plus the modifier of the ability you increased with this feat.'),
    ...
    ('Observant', 4, 'General Feat,  Increase your Intelligence or Wisdom score by 1, to a maximum of 20.Choose one of the following skills: Insight, Investigation, or Perception. If you lack proficiency with the chosen skill, you gain proficiency in it, and if you already have proficiency in it, you gain Expertise in it.You can take the Search Action as a Bonus Action.'),
    ('Polearm Master', 4, 'General Feat, Increase your Dexterity or Strength score by 1, to a maximum of 20. Immediately after you take the Attack action and attack with a Quarterstaff, a Spear, or a weapon that has the Heavy and Reach properties, you can use a Bonus Action to make a melee attack with the opposite end of the weapon. The weapon deals Bludgeoning damage, and the weapons damage die for this attack is a d4. While youre holding a Quarterstaff, a Spear, or a weapon that has the Heavy and Reach properties, you can take a Reaction to make one melee attack against a creature that enters the reach you have with that weapon.'),
    ...
    ('Speedy', 4, 'General Feat, Increase your Dexterity or Constitution score by 1, to a maximum of 20. Your Speed increases by 10 feet. When you take the Dash action on your turn, Difficult Terrain doesnt cost you extra movement for the rest of that turn. Opportunity Attacks have Disadvantage against you.'),
